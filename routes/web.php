...
Route::prefix("yonetici")->middleware("adminverified")->group(function (){
    ...
    Route::get('/ogrenci', [AdminController::class, 'students'])->name("adminstudent");
    ...
    Route::get('/danisman', [AdminController::class, 'teachers'])->name('adminteacher');
    ...
    Route::get('/donem/{id?}', [AdminController::class, 'periods'])->name('adminperiod');
    ...
    Route::post('/donem/add', [AdminController::class, 'periodsaddpost'])->name('periodsaddpost');
    Route::post('/donem/active', [AdminController::class, 'periodsactivepost'])->name('periodsactivepost');
