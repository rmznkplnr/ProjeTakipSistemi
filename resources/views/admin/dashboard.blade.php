                            ...
                            <div class="card-body scroll">
                                <div style="height: 740px" class="content vscroll">
                                    @foreach($projeler as $proje)
                                        <div class="d-flex overflow-visible mb-3">
                                            <div class="ps-3 flex-column">
                                                <div class="notify-time">
                                                    <p data-bs-toggle="tooltip" data-bs-placement="right" title="{{$proje->updated_at->format("d.m.Y H:i")}}" class="fs-10 lead mt-6 me-0">{{\App\Traits\Support\StringTrait::timeConvert($proje->updated_at)}}</p>
                                                </div>
                                                <span class="badge {{$proje->durum->stil}} me-1 mb-1 mt-1">{{$proje->durum->adi}}</span>
                                                <h4 class="mb-0">
