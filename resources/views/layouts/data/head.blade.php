                                        ...
                                        <div class="notifications-menu">
                                            ...
                                            @foreach($__bildirimler as $__bildirim)
                                                <a class="dropdown-item d-flex bildirim" data-id="{{$__bildirim->id}}" href="{{route('studentdetailproject',$__bildirim->proje_id)}}">
                                                    <div style="position: relative" class="me-3 notifyimg  {{$__bildirim->durum->stil}} brround box-shadow-primary">
                                                        <i style="top: 12.5px; left: 10px; position: absolute" class="{{$__bildirim->durum->ikon}}"></i>
                                                    </div>
                                                    <div class="mt-1">
